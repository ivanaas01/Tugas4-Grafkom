...
void Demo::Render() {
	...
	lightView = glm::lookAt(glm::vec3(-2.0f, 4.0f, -1.0f), glm::vec3(2.0f, 2.0f, 2.0f), glm::vec3(0.0, 2.0, 0.0));
	...
	glUniform3f(glGetUniformLocation(this->shadowmapShader, "lightPos"), -4.0f, 2.0f, -4.0f);
	glUniform3f(glGetUniformLocation(this->shadowmapShader, "lightColor"), 1.0f, 1.0f, 1.0f);
